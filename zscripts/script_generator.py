...
for i in range(5):
    for j in range(101):
        ...
        with open(f"./of0p{i}/of0p{i}oe{j}.slurm", "w") as outfile:
            ...
            outfile.write(
                f"mpirun -np 40 python main.py distancetogoal -of 0.{i} -oe {j} -sp {j} -p 500 -t 2500 -f of0p{i}oe0to100.json\n"
            )
...
#         outfile.write("module load openmpi/4.1.1/gcc\n")
#         outfile.write(
#             f"mpirun -np 10 python main.py distancetogoal -of 1.0 -oe {j} -sp {j} -p 500 -t 2500 -f of1p0oe0to100.json\n"
#         )
